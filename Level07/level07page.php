                    ...
                    <div class="row align-items-center justify-content-between no-gutters">
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        <li><a class="active" href="level07page.php">home</a></li>
                        ...
                        <div class="col-xl-2 col-lg-2 d-none d-lg-block">
                            <div class="buy_ticket">
                                <a href="download.php" class="boxed-btn-white">Buy Ticket</a>
                            </div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-xl-9">
                            <div class="title_text">
                                <h3>Digital Design <br>
                                    Conference <br>
                                    2019 NYC</h3>
                                <a href="download.php" class="boxed-btn-white">Add to your Calendar</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-5 offset-xl-1 col-md-6">
                    <div class="about_info">
                        ...
                        <a href="download.php" class="boxed-btn-red">Learn More</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-12">
                    <div class="resister_text text-center">
                        <h3>Register Now to Book <br>
                            Your Presence</h3>
                        <a href="download.php" class="boxed-btn-white">Book Now ($150) </a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-4 col-lg-4">
                            <div class="footer_widget">
                                ...
                                <ul>
                                    <li><a target="_blank" href="schedule.php">Schedule</a></li>
                                    <li><a target="_blank" href="speakers.php">Speakers</a></li>
