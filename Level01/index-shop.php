                ...
                <div class="container">
                    <div class="row mb50">
                            ...
                            <div class="hover-item mb30">
                                ...
                                <div class="hover-item-caption smoothie">
                                    <div class="vertical-center smoothie">
                                        <a href="slim-fit-shirt.php" class="smoothie btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="item-excerpt">
                                <h4 class="pull-right">$24.99</h4>
                                <h4><a href="slim-fit-shirt.php">Slim-Fit Shirt</a></h4>
                                <p>Taste oh spoke about no solid of hills up shade. Occasion so bachelor humoured striking by attended doubtful be it.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mb50">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="item-excerpt">
                                ...
                                <h4><a href="slim-fit-sihrt.php">Slim-Fit Sihrt</a></h4>
                                <p>Taste oh spoke about no solid of hills up shade. Occasion so bachelor humoured striking by attended doubtful be it.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
