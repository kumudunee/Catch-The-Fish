                    ...
                    <div class="clearfix">
                        ...
                        <div class="pull-right text-right">
                            <ul class="list-inline">
                                <li>
                                    <div><i class="fa fa-envelope-o"></i> IT18119336@domain.com</div>
                                </li>
                                <li>
                        ...
                        <ul class="masonry-portfolio-items isotope list-unstyled">
                                ...
                                <div class="hover-item">
                                    ...
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                                            <h3 class="smoothie mb30"><a href="index-agency-1.php" title="view project">Agency 1</a></h3>
                                            <a href="index-agency-1.php" class="smoothie btn btn-primary">View</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="col-sm-3 col-xs-6 masonry-portfolio-item apps isotope-item mb30">
                                <div class="hover-item">
                                    ...
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                                            <h3 class="smoothie mb30"><a href="index-blog-2.php" title="view project">Blog 2</a></h3>
                                            <a href="index-agency-1.php" class="smoothie btn btn-primary">View</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="col-sm-3 col-xs-6 masonry-portfolio-item apps isotope-item mb30">
                                <div class="hover-item">
                                    ...
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                                            <h3 class="smoothie mb30"><a href="index-corporate-1.php" title="view project">Corporate 1</a></h3>
                                            <a href="index-agency-1.php" class="smoothie btn btn-primary">View</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="col-sm-3 col-xs-6 masonry-portfolio-item apps isotope-item mb30">
                                <div class="hover-item">
                                    ...
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                                            <h3 class="smoothie mb30"><a href="index-landing-2.php" title="view project">Landing 2</a></h3>
                                            <a href="index-agency-1.php" class="smoothie btn btn-primary">View</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="col-sm-3 col-xs-6 masonry-portfolio-item apps isotope-item mb30">
                                <div class="hover-item">
                                    ...
                                    <div class="hover-item-caption smoothie">
                                        <div class="vertical-center smoothie">
                                            <h3 class="smoothie mb30"><a href="index-portfoio-1.php" title="view project">Portfolio 1</a></h3>
                                            <a href="index-agency-1.php" class="smoothie btn btn-primary">View</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right match-height">
                            <div class="vertical-center">
                                <span class="copyright">Copyright 2020. Designed by PMK</span>
                            </div>
                        </div>
                    </div>
                </div>
