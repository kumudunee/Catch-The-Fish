...
if(isset($_POST['keyInput02']))
{
	$key = mysqli_real_escape_string($db, $_POST['keyInput02']);
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="">
				...
				<br/>	<br/>
			<form method="POST" action="level02login.php">
				<label style="color:white;">Enter Key: </label> <input type="" name="keyInput02"><br/><br/>
